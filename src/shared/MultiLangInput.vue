  ...
  <div class="multi-lang-input">
    <div class="header-input">
      ...
      <div class="lang-switcher">
        <button v-for="lang in languages" :key="lang" type="button" class="lang-btn"
          :class="{ active: activeLang === lang }" @click="handleLangSwitch(lang)">
          {{ lang.toUpperCase() }}
    ...
    <div class="input-wrap">
      <textarea v-if="type == 'description'" v-model="currentValue" type="text" :placeholder="placeholder || `Enter ${label.toLowerCase()} in ${activeLang?.toUpperCase()}...`
        " class="field-input" :dir="activeLang === 'ar' ? 'rtl' : 'ltr'"></textarea>
      <input v-else v-model="currentValue" type="text" :placeholder="placeholder || `Enter ${label.toLowerCase()} in ${activeLang?.toUpperCase()}...`
        " class="field-input" :dir="activeLang === 'ar' ? 'rtl' : 'ltr'" />
