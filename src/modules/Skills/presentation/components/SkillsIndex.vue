  ...
  <div class="employee-page">
    <div class="index-header">
      <div class="search-field">
        ...
        <input v-model="word" placeholder="Search by skills…" class="search-input" type="text" @input="Search" />
      </div>
    ...
    <DataStatusBuilder :controller="state" :on-retry="async () => await fetchSkills()">
      <template #success="{ data }">
        <div class="table-frame">
          <AppTable :headers="headers" :items="data as SkillModel[]" :hoverable="true" :striped="true" show-index>
            ...
            <template #actions="{ item }">
              <div class="row-actions">
                <router-link class="action-btn edit" :to="`/${route.params.country_code}/skills/edit/${item.id}`"
                  title="Edit">
                ...
                <DeleteSkillsDialog @delete="deleteSkills(item.id!)"
