    ...
    <div class="form-fields">
      <div class="field-group">
        ...
        <div class="input-wrap">
          <input id="name" v-model="name" type="text" placeholder="Enter first name" class="field-input"
            @input="updateData" />
        </div>
      </div>
      <div class="field-group">
        ...
        <div class="input-wrap">
          <input id="name" v-model="lastName" type="text" placeholder="Enter last name" class="field-input"
            @input="updateData" />
        </div>
      </div>
      <div class="field-group">
        ...
        <div class="input-wrap">
          <input id="password" v-model="password" type="text" placeholder="Enter Password" class="field-input"
            @input="updateData" />
        </div>
      </div>
      ...
      <div class="field-group col-span-1">
        ...
        <div class="input-wrap">
          <input id="email" v-model="email" type="email" placeholder="enter your email" class="field-input"
            @input="updateData" />
        </div>
      </div>
      <div class="field-group">
        ...
        <div class="input-wrap">
          <input id="employeeId" v-model="employeeId" type="tel" placeholder="Enter Employee ID" class="field-input"
            @input="updateData" />
        </div>
      </div>
      <div class="field-group">
        ...
        <div class="input-wrap">
          <input id="phone" v-model="phone" type="tel" placeholder="Enter phone number" class="field-input"
            @input="updateData" />
        </div>
      </div>
      ...
      <div class="field-group">
        ...
        <div class="gender-group">
          ...
          <div class="input-field">
            <RadioButton v-model="gender" input-id="female" name="gender" :value="GenderENum.female" />
      ...
      <div class="field-group col-span-2">
        <HandleFilesUpload :label="`upload image`" accept="image/*" :multiple="false" :index="1" :file="UploadedImage"
