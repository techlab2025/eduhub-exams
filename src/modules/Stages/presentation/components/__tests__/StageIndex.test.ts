...
import { ref } from 'vue';
import StageIndex from '../StageIndex.vue';
...
// ── Controller ────────────────────────────────────────────────────────────────
vi.mock('../../controllers/stage.controller', () => ({
...
describe('StageIndex.vue', () => {
  ...
  it('renders the index wrapper', () => {
    const wrapper = mount(StageIndex, mountOptions);
