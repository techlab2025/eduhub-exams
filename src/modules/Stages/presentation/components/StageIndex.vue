    ...
    <div class="index-header">
      <div class="toolbar">
        <div class="search-field">
          ...
          <input v-model="word" placeholder="Search by country name or code…" class="search-input" type="text"
            @input="Search" />
        </div>
      </div>
    ...
    <DataStatusBuilder :controller="state" :on-retry="async () => await fetchStages()">
      <template #success="{ data }">
        <div class="table-frame">
          <AppTable :headers="headers" :items="data as StageModel[]" selectable show-index hoverable striped
