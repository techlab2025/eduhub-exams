...
vi.mock(
  '@/modules/EducationCalssification/presentation/controllers/educationConfiguration/education.configuration.controller',
  () => ({
    default: {
      getInstance: () => ({
...
vi.mock(
  '@/modules/EducationCalssification/presentation/controllers/educationSubject/education.subject.controller',
  () => ({
    default: {
      getInstance: () => ({
