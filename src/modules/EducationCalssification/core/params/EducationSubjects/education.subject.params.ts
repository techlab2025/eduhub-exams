 ...
 */
export default class EducationSubjectParams implements Params {
  levelNumber: number;
  ...
  validate() {
    return EducationSubjectParams.validation.validate(this);
  }

  validateOrThrow() {
    return EducationSubjectParams.validation.validateOrThrow(this);
  }
}
