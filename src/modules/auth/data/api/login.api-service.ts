...
export default class LoginApiService extends BaseApiService {
  ...
  private generalLoginEndpoints = new GeneralLoginEndpoints();
  ...
  async generalLogin(params: Params): Promise<ApiResponse> {
    return this.customPost(this.generalLoginEndpoints.login, params);
  }
}
