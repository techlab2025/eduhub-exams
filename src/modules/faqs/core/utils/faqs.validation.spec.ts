...
import { isValidCountryCode, isValidCountryTitle, normalizeCountryCode } from './faqs.validation';

describe('Country Validation Utilities', () => {
  ...
  describe('normalizeCountryCode', () => {
    ...
    it('should return empty string for invalid input', () => {
      expect(normalizeCountryCode(null as unknown as string)).toBe('');
      expect(normalizeCountryCode(undefined as unknown as string)).toBe('');
    });
  });
});
