      ...
      <div class="form-header-left">
        <span class="form-icon">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="12" r="10" fill="#4faf7c"/>
            <path d="M12 7C10.34 7 9 8.34 9 10H11C11 9.45 11.45 9 12 9C12.55 9 13 9.45 13 10C13 12 10 11.75 10 14H12C12 12.75 15 12.5 15 10C15 8.34 13.66 7 12 7ZM11 15V17H13V15H11Z" fill="white"/>
          </svg>
        </span>
    ...
    <div class="faq-form-fields">
      <div class="field-group">
        <MultiLangInput
          ...
          @update:model-value="question = $event; emitData()"
        />
      </div>
      ...
      <div class="field-group">
        <MultiLangInput
          ...
          @update:model-value="answer = $event; emitData()"
        />
      </div>
    </div>
  </div>
