...
export const PlanFeatureSubTypeEnum = {
  SHOW_OVERALL_SCORE: '1.1',
  SHOW_SKILL_ANALYSIS: '1.2',
  SHOW_CURRICULUM_ANALYSIS: '1.3',
  ALLOW_REPORT_DOWNLOAD: '1.4',
  MAXIMUM_REPORTS_PER_STUDENT: '1.5',
  MAX_DOWNLOADS_PER_MONTH: '1.6',
  OVERALL_PROGRESS_OVERVIEW: '2.1',
  NEEDS_FOCUS_SECTION: '2.2',
  SUBJECTS_WITH_PROGRESS_TRACKING: '2.3',
  MAXIMUM_PROGRESS_HISTORY: '2.4',
  ALLOW_STUDENTS_TO_VIEW_THEIR_SCHEDULE: '3.1',
  ALLOW_STUDENTS_TO_SET_REMINDERS: '3.2',
  MAXIMUM_SCHEDULES_PER_DAY: '3.3',
  SHOW_SUBJECTS_STUDIED: '4.1',
  MAXIMUM_ITEMS_SHOWN: '4.2',
  MIND_MAPS: '5.1',
  FLASH_CARDS: '5.2',
  PRACTICE_EXAMS: '5.3',
  MAXIMUM_MIND_MAPS: '5.4',
  MAXIMUM_FLASH_CARD_SETS: '5.5',
} as const;
