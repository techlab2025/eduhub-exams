...
export default class AddBlockReasonsParams implements Params {
  ...
  validate() {
    return AddBlockReasonsParams.validation.validate(this);
  }

  validateOrThrow() {
    return AddBlockReasonsParams.validation.validateOrThrow(this);
  }
}
