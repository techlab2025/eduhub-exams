...
export default class IndexBlockReasonsParams implements IndexParams {
  public word: string = '';
  ...
  validate() {
    return IndexBlockReasonsParams.validation.validate(this);
  }

  validateOrThrow() {
    return IndexBlockReasonsParams.validation.validateOrThrow(this);
  }
}
