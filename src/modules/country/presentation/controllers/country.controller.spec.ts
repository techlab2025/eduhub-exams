...
import EmailController from "./country.controller";
...
describe("EmailController", () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(controller as any, "repository", "get").mockReturnValue(
      mockRepository,
    );
  });
  ...
  describe("fetchOne - fetch single email", () => {
    ...
    it("should pass options to repository", async () => {
      ...
      const successState = EmailTestFactory.success(
        EmailTestFactory.createMockEmail(),
      );
      mockRepository.show.mockResolvedValue(successState);
  ...
  describe("delete - delete email", () => {
    it("should call repository.delete with params", async () => {
      const successState = new DataSuccess<void>({
  ...
  describe("edge cases and error scenarios", () => {
    ...
    it("should handle concurrent requests", async () => {
      const successState1 = EmailTestFactory.success([
        EmailTestFactory.createMockEmail({ id: 1 }),
      ]);
      const successState2 = EmailTestFactory.success([
        EmailTestFactory.createMockEmail({ id: 2 }),
      ]);
