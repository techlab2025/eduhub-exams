...
describe("Email Validation Utilities", () => {
  ...
  describe("validateAndNormalizeEmail", () => {
    it("should return normalized email for valid input", () => {
      expect(validateAndNormalizeEmail("Test@Example.COM")).toBe(
        "test@example.com",
      );
    });
    ...
    it("should handle whitespace and validate", () => {
      expect(validateAndNormalizeEmail("  Valid@Example.com  ")).toBe(
        "valid@example.com",
      );
    });
  });
  ...
  describe("extractEmailDomain", () => {
    it("should extract domain from valid email", () => {
      ...
      expect(extractEmailDomain("test@sub.example.co.uk")).toBe(
        "sub.example.co.uk",
      );
    });
  ...
  describe("isEmailFromDomain", () => {
    ...
    it("should return false for subdomain mismatch", () => {
      expect(isEmailFromDomain("user@sub.example.com", "example.com")).toBe(
        false,
      );
    });

    it("should match exact subdomain", () => {
      expect(isEmailFromDomain("user@sub.example.com", "sub.example.com")).toBe(
        true,
      );
    });
  });
