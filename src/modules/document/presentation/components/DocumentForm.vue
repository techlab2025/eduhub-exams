    ...
    <div class="form-fields">
      ...
      <div class="field-group col-span-2">
        ...
        <UpdatedCustomInputSelect id="documentType" :label="`Document Type`" :params="indexDocumentTypeParams"
          :controller="documentTypeController" :model-value="selectedDocumentType as TitleInterface<number>"
          :placeholder="$t('Document Type')" @update:model-value="
      ...
      <div class="field-group col-span-2">
        ...
        <HandleFilesUpload :label="`upload image`" accept="image/*" :multiple="true" :index="1" :file="UploadedImage"
          :have-content="true" :class="`image-input`" @update:model-value="handleImageChange">
