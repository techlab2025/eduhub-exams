  ...
  <div class="document-form-card">
    ...
    <div class="form-fields">
      ...
      <div class="field-group">
        <MultiLangInput :field-key="`title`" :label="$t(`Document_name`)" :languages="['en', 'ar']" :model-value="title"
          :type="`title`" @update:model-value="
            title = $event;
          updateData();
          " />
      </div>
      ...
      <div class="field-group col-span-1 ref-number-group">
        ...
        <div class="input-wrap">
          <input id="doc-ref" v-model="RefrenceNumber" type="text" :placeholder="$t('enter_refrence_number')"
      ...
      <div class="field-group col-span-2">
        <UpdatedCustomInputSelect id="documentType" :label="`Document Type`" :params="indexDocumentTypeParams"
          :controller="documentTypeController" :model-value="selectedDocumentType" :placeholder="$t('Document Type')"
          @update:model-value="
      ...
      <div class="field-group col-span-2">
        <UpdatedCustomInputSelect id="doc-branch" :label="`Stage Name`" :static-options="branchOptions"
          :model-value="selectedBranchTitle" :placeholder="$t('Stage Name')" :reload="false"
      ...
      <div v-if="selectedBranch && subjectOptions.length > 0" class="field-group col-span-2">
        <UpdatedCustomInputSelect id="doc-subject" :label="`Subject Name`" :static-options="subjectOptions"
          :model-value="selectedSubject" :placeholder="$t('Subject Type')" :reload="false" @update:model-value="
            (event) => {
      ...
      <div class="field-group col-span-2">
        <MultiLangInput :field-key="`description`" :label="$t(`Description`)" :languages="['en', 'ar']"
          :model-value="description" :type="`description`" @update:model-value="
            description = $event;
          updateData();
          " />
      </div>
      ...
      <div class="field-group tags-group col-span-2">
        ...
        <div class="input-wrap input-tag-wrap">
          <input id="tags" v-model="tag" type="text" :placeholder="$t('Add tag....')" class="field-input"
            @input="updateData" />
      ...
      <!-- Upload Files -->
      <div class="field-group col-span-2">
        <HandleFilesUpload :label="`upload document`" accept=".pdf" :multiple="true" :index="2" :file="UploadedFiles"
