...
const deleteDialogMessage = ref('Deleting this document will remove all related data. This action is irreversible, and the document must be created again if needed.')
</script>
          ...
          <AppTable :headers="headers" :items="data as DocumentModel[]" selectable show-index hoverable striped>
            ...
            <template #actions="{ item }">
              <div class="row-actions">
                <router-link class="action-btn edit" :to="`/documents/edit/${item.id}`" title="Edit">
