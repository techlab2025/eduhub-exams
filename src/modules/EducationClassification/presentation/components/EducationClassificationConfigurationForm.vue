...
const fillConfigurationForm = (data: EducationConfigurationModel | undefined) => {
  ...
  console.log(configurationInitialBranches.value, "configurationInitialBranches.value ")
};
...
<template>
  <div class="education-classification-configuration-form-container">
    <div class="education-classification-form-card">
      ...
      <SingularPluralForm :numberOfBranches="ConfigurationNumberOfBranchs" :label="$t('name_of_branch')"
    ...
    <div class="education-classification-form-card">
      ...
      <div class="education-classification-form-fields">
        ...
        <div class="field-group">
          <div class="input-wrap">
            <MultiLangInput :field-key="`title_Singular`" :label="$t(`subjects_name_(Singular)`)"
              :languages="['en', 'ar']" :model-value="subject_title_Singular" :type="`title`"
        ...
        <div class="field-group">
          <div class="input-wrap">
            <MultiLangInput :field-key="`title_Plural`" :label="$t(`subjects_name_(Plural)`)" :languages="['en', 'ar']"
              :type="`title`" :model-value="subject_title_Plural" @update:model-value="subject_title_Plural = $event" />
          </div>
        </div>
        ...
        <div class="field-group">
          ...
          <div class="input-wrap">
            <input id="subject_number" v-model="SubjectnumberOfBranchs" type="number" :placeholder="$t('num_of_levels')"
