...
import EducationClassificationEdit from '../EducationClassificationEdit.vue';
...
describe('EducationClassificationEdit', () => {
  beforeEach(() => {
  ...
  it('renders without crashing', () => {
    const wrapper = mount(EducationClassificationEdit, {
      global: {
        stubs: {
          Teleport: true,
          Transition: true,
