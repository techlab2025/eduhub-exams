...
// ─── Dialog assets ────────────────────────────────────────────────────────────
vi.mock("@/assets/images/dialogs/Success.gif", () => ({
...
vi.mock("@/assets/images/user-image.png", () => ({
  default: "mocked-user-image.png",
}));
...
vi.mock("@/assets/images/CheckBoxImg.png", () => ({
  default: "mocked-checkbox.png",
}));
vi.mock("@/assets/images/Checklist.gif", () => ({
  default: "mocked-checklist.gif",
}));
vi.mock("@/assets/images/Sort.gif", () => ({ default: "mocked-sort.gif" }));
vi.mock("@/assets/images/TextArea.gif", () => ({
  default: "mocked-textarea.gif",
}));
vi.mock("@/assets/images/DataFailed.gif", () => ({
  default: "mocked-data-failed.gif",
}));
vi.mock("@/assets/images/app/system-failed.png", () => ({
  default: "mocked-system-failed.png",
}));
vi.mock("@/assets/images/Your-paragraph-text-1--unscreen.gif", () => ({
  default: "mocked-main-loader.gif",
}));
vi.mock("@/assets/images/HeaderBack.png", () => ({
  default: "mocked-header-back.png",
}));
vi.mock("@/assets/images/EmployeeBg.png", () => ({
  default: "mocked-employee-bg.png",
}));
vi.mock("@/assets/images/Yellowback.png", () => ({
  default: "mocked-yellow-back.png",
}));
vi.mock("@/assets/images/BgGroup.png", () => ({
  default: "mocked-bg-group.png",
}));
vi.mock("@/assets/images/yelloecircle.png", () => ({
  default: "mocked-yelloecircle.png",
}));
